...
const serviceName = "TOpNeTze"; // Ganti dengan nama workers kalian
...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/He3ndrixx/ipzz/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>NeTTOpze</span>");
